  ...
  validateAccount = async () => {
    ...
    return window.web3.personal.sign(
      window.web3.fromUtf8(
        `Hi there from Mutatio! To connect, sign this message to prove you have access to this account. This won’t cost you any Ether.
 
      ...
      (error, signature) => {
        if (error) {
          ...
          window.toastProvider.addMessage(successMessage, {
            variant: "success",
            secondaryMessage: "Welcome to the Mutatio Demo App 🎉"
          });
